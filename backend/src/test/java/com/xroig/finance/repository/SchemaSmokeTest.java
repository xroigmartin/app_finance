...
/**
 * Sanity check for the Testcontainers infra (stage T0): the container starts,
 * Flyway builds the schema and Hibernate validates the entities against it, so a
 * repository query runs without error.
 */
