...
2. ~~Historial de imports~~ — ✅ implementado (RF-11, `docs/plan/historial-imports.md`, F3.5 de `docs/prd/inversiones.md`): persiste fecha/fichero/resumen ok-duplicadas-errores-warnings y expone una vista de consulta paginada.
