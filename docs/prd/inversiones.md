...
| Campo | Valor |
|---|---|
| Estado | 🚧 En implementación — **F1 y F2 completas** (modelo + import Flex + posiciones/valoración + UI + rentas + alta manual); F3 (TWR/XIRR) pendiente |
| Versión | 0.38 |
