...
Pendiente (estructura prevista): alta manual — H2.3; UI de rentas — H2.4; `PerformanceView` + `PerformanceCalculator` — F3 y `PerformanceView` + `PerformanceCalculator` — F3; tarjeta de patrimonio en el dashboard doméstico — H1.12.
