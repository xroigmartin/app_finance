...
| Campo | Valor |
|---|---|
| Estado | ✅ **Implementado** — F1, F2 y F3 completas (modelo + import Flex + posiciones/valoración multidivisa + rentas + alta manual + rentabilidad TWR/XIRR, con UI); F4 (automatización) **parcialmente implementada**: H4.1 (API externa de cotizaciones, Yahoo Finance) sí, H4.2/H4.3 (Flex Web Service, modo híbrido) no |
| Versión | 0.48 |
