...
| H-CP.4 | Frontend: pestaña "Cerradas" en `investments-operations` (3ª posición: Operaciones/Dividendos/Cerradas/Importaciones), selector de año y tabla agregada por instrumento + fila TOTAL. | Vitest + Playwright (opcional). | pendiente |
