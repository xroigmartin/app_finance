...
| Campo | Valor |
|---|---|
| Estado | 🚧 En implementación — **F1 completa** (modelo + import Flex + posiciones/valoración multidivisa + UI); F2 (rentas y alta manual) y F3 (TWR/XIRR) pendientes |
| Versión | 0.36 |
